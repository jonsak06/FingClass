...
public:
    DtAsignatura();
    ~DtAsignatura();
    DtAsignatura(string codigoAsignatura, string nombreAsignatura, bool teorico, bool practico, bool monitoreo, float tiempoTotalDictado);
    DtAsignatura(string codigoAsignatura, string nombreAsignatura, bool teorico, bool practico, bool monitoreo);
    DtAsignatura(string nombreAsignatura, float tiempoTotalDictado);
